							...
							{:else if customFitGrading}
								<div class="overflow-x-auto mb-4">
									<table class="tbl"><thead><tr><th></th><th>Pattern ({customFitGrading.target_size})</th><th class="tv">Custom</th><th>Delta</th></tr></thead>
										<tbody>{#each [{l:'Bust',s:customFitGrading.target_finished.bust_cm,c:customFitGrading.custom_finished.bust_cm,d:customFitGrading.target_finished.bust_cm && customFitGrading.custom_finished.bust_cm ? +(customFitGrading.custom_finished.bust_cm - customFitGrading.target_finished.bust_cm).toFixed(1) : 0},{l:'Waist',s:customFitGrading.target_finished.waist_cm,c:customFitGrading.custom_finished.waist_cm,d:customFitGrading.target_finished.waist_cm && customFitGrading.custom_finished.waist_cm ? +(customFitGrading.custom_finished.waist_cm - customFitGrading.target_finished.waist_cm).toFixed(1) : 0},{l:'Hip',s:customFitGrading.target_finished.hip_cm,c:customFitGrading.custom_finished.hip_cm,d:customFitGrading.target_finished.hip_cm && customFitGrading.custom_finished.hip_cm ? +(customFitGrading.custom_finished.hip_cm - customFitGrading.target_finished.hip_cm).toFixed(1) : 0},{l:'Length',s:customFitGrading.target_finished.full_length_cm,c:customFitGrading.custom_finished.full_length_cm,d:customFitGrading.target_finished.full_length_cm && customFitGrading.custom_finished.full_length_cm ? +(customFitGrading.custom_finished.full_length_cm - customFitGrading.target_finished.full_length_cm).toFixed(1) : 0}] as r}
